...
const Template01 = ({ data, onClick=()=>{} }) => {
  ...
  return (
    <div className="template template-01">
      <h6 onClick={e => handleClick(e, 'field1')} className="editable" 
        style={{ color: thisData?.field1?.color || 'inherit' }} 
      >
        {thisData?.field1?.value || 'Field 1'}
      </h6>
      <h6 onClick={e => handleClick(e, 'field2')} className="editable" 
      ...
      <div className="blocks">
        ...
        <div className="block">
          ...
          <p onClick={e => handleClick(e, 'field8')} className="editable" 
