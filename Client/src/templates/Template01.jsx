...
const Template01 = ({ data, disabled=false, onClick=()=>{}, user=null }) => {
  ...
  const thisData = useMemo(() => {
    return {
      Field1: replaceRules(data?.Field1 || { type: 'text', value: '[FirstName] [LastName]', color: '#1B1560' }, user),
      Field2: replaceRules(data?.Field2 || { type: 'text', value: '[FirstNameEN] [LastNameEN]', color: '#1B1560' }, user),
